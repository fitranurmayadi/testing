...
const char* ssid = "KampungTongah";
const char* password =  "sayasiapaya";
const char* mqttServer = "18.214.251.229";
const int mqttPort = 1883;
const char* mqttUser = "nurmayadi";
const char* mqttPassword = "nurmayadi123";
